    ...
    <div class='page'>
        ...
        <div style='padding: 20px 0 30px 0'>
            <Form ref="dataplan" :model="dataplan" :rules="ruleValidate" label-position="left" :label-width="100">
                ...
                <span v-if='this.$route.params.ifs == 0 && (listitem.discount != 1 && listitem.discount != "" && listitem.discount != null && listitem.totalAmount != null)'>, 折扣后总价【{{formatNumber(listitem.totalAmount , 2)}}】</span>
