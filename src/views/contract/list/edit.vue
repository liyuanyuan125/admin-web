  ...
  <Form  :model='item' :label-width='88' :rules='rules' label-position="left" class='form page' ref='dataForms'>
    ...
    <div class="edit-box">
      ...
      <Row class="cinema-header">
        ...
        <FormItem label="甲方公司" prop="shortName">
          <Row>
            <Col span="8">
      ...
      <Row class="cinema-header">
        ...
        <FormItem label="联系人" prop="shortName">
          <Row>
            <Col span="8">
              <Input v-model="item.shortName"/>
            </Col>
      ...
      <Row class="cinema-header">
        ...
        <FormItem label="开户名" prop="shortName">
          <Row>
            <Col span="8">
              <Input v-model="item.shortName"/>
            </Col>
      ...
      <!-- <Row class="cinema-footer">
        ...
        <Row>
          <FormItem prop="cinemasList">
            <PartBindCinema v-model="item.cinemasList" :unitList="profitUnitList"
