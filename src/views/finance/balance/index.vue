...
export default class Main extends ViewBase {
  ...
  columns = [
    { title: '序号', key: 'resourceBillNo', minWidth: 65 },
    { title: '公司ID', key: 'cinemaName', minWidth: 100 },
    { title: '公司名称', key: 'code', minWidth: 60 },
    { title: '账户余额', key: 'resourceName', minWidth: 60 },
    { title: '可用金额', key: 'contractNo', minWidth: 100 },
